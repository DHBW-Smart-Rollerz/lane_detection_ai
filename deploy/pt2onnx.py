...
def get_args():
    ...
    parser.add_argument(
        "--config_path",
        default="configs/culane_res34.py",
        help="path to config file",
        type=str,
    )
    parser.add_argument(
        "--model_path",
        default="weights/culane_res34.pth",
        help="path to model file",
        type=str,
    )
    parser.add_argument(
        "--accuracy", default="fp16", choices=["fp16", "fp32"], type=str
    )
    parser.add_argument(
        "--size", default=(256, 192), help="size of original frame", type=tuple
    )
